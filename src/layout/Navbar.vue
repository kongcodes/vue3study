<template>
  <el-row class="elrow">
    ...
    <el-col :xs="8" :sm="8" :md="16" :lg="16" :xl="16">
      <el-menu :default-active="$route.path" class="el-menu-nav hidden-sm-and-down" mode="horizontal"
        @select="handleSelect" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b" :router="true">
        <el-menu-item v-for="item in navItem" :index="item.url">
          {{ item.name }}
        </el-menu-item>
      </el-menu>
      <div class="icon-box hidden-sm-and-up">
        <el-menu :default-active="$route.path" class="el-menu2" mode="horizontal" menu-trigger="click"
